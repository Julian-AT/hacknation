...
export const FACILITIES_SCHEMA: ColumnDef[] = [
  ...
  { column: "id", type: "serial", description: "Primary key (auto-increment)" },
  {
    column: "pk_unique_id",
    type: "integer",
    description: "Original source unique ID",
  },
  { column: "name", type: "text", description: "Facility name (NOT NULL)" },
  {
    column: "source_url",
    type: "text",
    description: "URL the data was scraped from",
  },
  ...
  // Classification
  {
    ...
    type: "text",
    description: "Type: hospital, clinic, doctor, pharmacy, dentist",
  },
  {
    column: "operator_type",
    type: "text",
    description: "Operator: public, private",
  },
  {
  ...
  { column: "address_country", type: "text", description: "Country name" },
  {
    column: "country_code",
    type: "text",
    description: "ISO country code (e.g., GH, NG, KE)",
  },
  {
    column: "lat",
  ...
  // Capacity
  {
    column: "num_doctors",
    type: "integer",
    description: "Number of doctors (often null — ~600 nulls)",
  },
  {
    column: "capacity",
    type: "integer",
    description: "Bed count (often null — ~700 nulls)",
  },
  {
    column: "area_sqm",
    type: "integer",
  ...
  {
    column: "specialties_raw",
    type: "text",
    description: "Raw free-text specialties (use ILIKE for search)",
  },
  {
    column: "procedures_raw",
    type: "text",
    description: "Raw free-text procedures (use ILIKE for search)",
  },
  {
    column: "equipment_raw",
    type: "text",
    description: "Raw free-text equipment (use ILIKE for search)",
  },
  {
    column: "capabilities_raw",
    type: "text",
    description: "Raw free-text capabilities (use ILIKE for search)",
  },
  {
    column: "description",
    type: "text",
    description: "General description of the facility",
  },
  {
    column: "mission_statement",
    type: "text",
    description: "Facility mission statement",
  },
  {
  ...
  // Parsed arrays (structured from free-text)
  {
    column: "specialties",
    type: "text[]",
    description: "Parsed array of specialties (use ANY() for filtering)",
  },
  {
    column: "procedures",
    type: "text[]",
    description: "Parsed array of procedures (use ANY() for filtering)",
  },
  {
    column: "equipment",
    type: "text[]",
    description: "Parsed array of equipment (use ANY() for filtering)",
  },
  {
    column: "capabilities",
    type: "text[]",
    description: "Parsed array of capabilities (use ANY() for filtering)",
  },
  {
    column: "affiliation_types",
    type: "text[]",
    description: "Parsed array of affiliation types",
  },

  // Other
  {
    column: "accepts_volunteers",
    type: "boolean",
    description: "Whether the facility accepts volunteers",
  },
  {
    column: "created_at",
    type: "timestamp",
...
export const FACILITIES_COLUMNS_HINT = `Available columns include: ${KEY_COLUMNS.join(", ")}, and more. Use the getSchema tool for the full list.`;
...
export const DEMOGRAPHICS_COUNTRIES_SCHEMA: ColumnDef[] = [
  {
    column: "country_code",
    type: "varchar(3)",
    description: "ISO 3166-1 alpha-3 country code (PK, e.g. GHA, NGA, KEN)",
  },
  {
    column: "country_name",
    type: "text",
    description: "Country name (NOT NULL)",
  },
  {
    column: "total_population",
    type: "bigint",
    description: "Total population (national)",
  },
  {
  ...
  },
  {
    ...
    type: "double precision",
    description: "Nurses/midwives per 1,000 people",
  },
  {
    column: "beds_per_1000",
    type: "double precision",
    description: "Hospital beds per 1,000 people",
  },
  {
    column: "maternal_mortality_per_100k",
    type: "double precision",
    description: "Maternal mortality ratio per 100,000 live births",
  },
  {
    column: "under5_mortality_per_1k",
    type: "double precision",
  ...
  },
  {
    column: "data_source",
    type: "text",
    description: "Data source (e.g. World Bank API 2024)",
  },
  {
    column: "updated_at",
    type: "timestamp",
...
export const DEMOGRAPHICS_REGIONS_SCHEMA: ColumnDef[] = [
  { column: "id", type: "serial", description: "Primary key (auto-increment)" },
  {
    column: "country_code",
    type: "varchar(3)",
    description: "ISO country code (FK to demographics_countries)",
  },
  ...
  {
    column: "urban_percent",
    type: "double precision",
    description: "Urban population percentage",
  },
  {
    column: "rural_percent",
    type: "double precision",
  ...
  },
  {
    ...
    type: "text",
    description: "Classification: urban-heavy, semi-urban, rural-heavy",
  },
  {
    column: "gdp_per_capita_usd",
    type: "double precision",
    description: "Regional GDP per capita (USD)",
  },
  {
    column: "age_under15_pct",
    type: "double precision",
    description: "Percentage of population under 15",
  },
  {
    column: "age_working_pct",
    type: "double precision",
    description: "Percentage of working-age population (15-64)",
  },
  {
    column: "age_over65_pct",
    type: "double precision",
  ...
  },
  {
    column: "maternal_mortality_per_100k",
    type: "double precision",
    description: "Regional maternal mortality per 100,000 live births",
  },
  {
    column: "under5_mortality_per_1k",
    type: "double precision",
    description: "Regional under-5 mortality per 1,000 live births",
  },
  {
    column: "doctors_per_1000",
    type: "double precision",
  ...
  },
  {
    column: "nurses_per_1000",
    type: "double precision",
    description: "Nurses per 1,000 people",
  },
  {
    column: "disease_burden",
    type: "text[]",
    description: "Common diseases in the region (use ANY() for filtering)",
  },
...
export const DEMOGRAPHICS_BENCHMARKS_SCHEMA: ColumnDef[] = [
  { column: "id", type: "serial", description: "Primary key (auto-increment)" },
  {
    ...
    type: "text",
    description:
      "Benchmark name: WHO Minimum, Developed Country Average (UNIQUE)",
  },
  {
    column: "doctors_per_1000",
    type: "double precision",
  ...
  },
  {
    column: "maternal_mortality_per_100k",
    type: "double precision",
    description: "Maternal mortality per 100,000 live births",
  },
  {
    column: "under5_mortality_per_1k",
    type: "double precision",
    description: "Under-5 mortality per 1,000 live births",
  },
  {
    column: "ophthalmologists_per_capita",
    type: "double precision",
    description: "Ophthalmologists per capita",
  },
  {
    column: "surgeons_per_capita",
    type: "double precision",
    description: "Surgeons per capita",
  },
  {
    column: "operating_rooms_per_100k",
    type: "double precision",
    description: "Operating rooms per 100,000 people",
  },
  { column: "data_source", type: "text", description: "Data source" },
  {
    column: "updated_at",

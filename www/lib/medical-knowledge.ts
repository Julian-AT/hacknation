...
export const MEDICAL_KNOWLEDGE = {
  ...
  specialtyInfrastructure: {
    neurosurgery: {
      minBeds: 100,
      minDoctors: 5,
      requiredEquipment: ["ct", "mri", "icu", "operating room"],
    },
    "cardiac surgery": {
      minBeds: 50,
      minDoctors: 5,
      requiredEquipment: ["icu", "cath lab", "operating room"],
    },
    "organ transplant": {
      minBeds: 100,
      minDoctors: 10,
      requiredEquipment: ["icu", "operating room", "blood bank"],
    },
    oncology: {
      minBeds: 50,
      minDoctors: 3,
      requiredEquipment: ["chemotherapy", "radiation"],
    },
    neonatology: {
      minBeds: 30,
      minDoctors: 3,
      requiredEquipment: ["nicu", "incubator", "ventilator"],
    },
    nephrology: { minBeds: 20, minDoctors: 2, requiredEquipment: ["dialysis"] },
    cardiology: {
      minBeds: 30,
      minDoctors: 3,
      requiredEquipment: ["ecg", "echocardiography", "icu"],
    },
    orthopedics: {
      minBeds: 20,
      minDoctors: 2,
      requiredEquipment: ["x-ray", "operating room"],
    },
    ophthalmology: {
      minBeds: 5,
      minDoctors: 1,
      requiredEquipment: ["slit lamp", "operating microscope"],
    },
    radiology: { minBeds: 0, minDoctors: 1, requiredEquipment: ["x-ray"] },
  } as Record<
    string,
    { minBeds: number; minDoctors: number; requiredEquipment: string[] }
  >,
